/* empty css              *//* empty css              */const j="",L={args:{},argTypes:{title:{control:"text",description:"De titel van de timeline"},data:{control:"object"}},parameters:{docs:{description:{component:j}}},tags:["autodocs"],title:"Componenten/Timeline"},w=a=>{const n=document.createElement("ol");n.classList.add("dictu-timeline__body");for(let i=0;i<a.length;i+=1){const e=a[i],t=document.createElement("li");t.classList.add("dictu-timeline__item");const l=p(!1,"3",e.label,e.expanded);if(t.appendChild(l),e.content){const d=g(e.content,e.expanded);t.appendChild(d)}if(e.children){const d=document.createElement("ol");d.classList.add("dictu-timeline__sub-list"),e.expanded||d.classList.add("dictu-display-none");for(let s=0;s<e.children.length;s+=1){const o=e.children[s],r=document.createElement("li");r.classList.add("dictu-timeline__sub-item");const v=p(!0,"4",o.label,o.expanded);if(r.appendChild(v),o.content){const b=g(o.content,o.expanded);r.appendChild(b)}d.appendChild(r)}t.appendChild(d)}n.appendChild(t)}return n},g=(a,n)=>{const i=document.createElement("div");i.classList.add("dictu-timeline__element-content-wrapper"),n||i.classList.add("dictu-display-none");const e=document.createElement("div");return e.classList.add("dictu-timeline__element-content"),e.innerHTML=a,i.appendChild(e),i},p=(a=!1,n,i,e)=>{const t=document.createElement("button");t.classList.add("dictu-timeline__element-button","dictu-button","dictu-button--subtle"),t.setAttribute("aria-expanded",e);const l=document.createElement("span");l.classList.add("dictu-timeline__element-heading-body");const d=f(a);d.classList.add(a?"dictu-timeline__icon--subheading":"dictu-timeline__icon--heading");const s=document.createElement(`h${n}`);return s.classList.add("dictu-heading",`dictu-heading--level-${n}`,"dictu-timeline__element-heading"),s.textContent=i,l.appendChild(d),l.appendChild(s),t.appendChild(l),t},f=(a=!1)=>{const n=document.createElement("span");return a?n.innerHTML=`
...
}`,...(u=(m=c.parameters)==null?void 0:m.docs)==null?void 0:u.source}}};const k=["Timeline"];export{c as Timeline,k as __namedExportsOrder,L as default};
