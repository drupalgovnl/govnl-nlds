...
`,f="Gebruik voor een hoofdkop van een pagina de `dictu-heading` en `dictu-heading--level-1` class name op een `h1` element.\n",j="Gebruik voor een koptekst die volgt na de hoofdkop en in de koppenstructuur op het tweede niveau staat de `dictu-heading` en `dictu-heading--level-2` class name op een `h2` element:\n",z="Gebruik voor een koptekst die in de koppenstructuur op het derde niveau staat de `dictu-heading` en `dictu-heading--level-3` class name op een `h3` element.\n",A="Gebruik voor een koptekst die in de koppenstructuur op het vierde niveau staat de `dictu-heading` en `dictu-heading--level-4` class name op een `h4` element.\n",W="Gebruik voor een koptekst die in de koppenstructuur op het vijfde niveau staat de `dictu-heading` en `dictu-heading--level-5` class name op een `h5` element.\n",x="Gebruik voor een koptekst die in de koppenstructuur op het zesde niveau staat de `dictu-heading` en `dictu-heading--level-6` class name op een `h6` element.\n",R={args:{innerHTML:"Dit is een voorbeeld van een heading"},argTypes:{innerHTML:{control:"text",description:"De tekst van de heading"},level:{control:"select",options:["1","2","3","4","5","6"],description:"Het niveau van de heading"}},parameters:{docs:{description:{component:C}}},render:({innerHTML:S,...i})=>{const E=["dictu-heading",`dictu-heading--level-${i.level}`],y=`h${i.level}`,o=document.createElement(y);return o.innerText=S,o.classList.add(...E),o},tags:["autodocs"],title:"Componenten/Heading"},e={args:{innerHTML:"Dit is een hoofdkop van een pagina",level:1},parameters:{docs:{description:{story:f}}}},n={args:{innerHTML:"Een koptekst die in de koppenstructuur op het tweede niveau staat",level:2},parameters:{docs:{description:{story:j}}}},t={args:{innerHTML:"Een koptekst die in de koppenstructuur op het derde niveau staat",level:3},parameters:{docs:{description:{story:z}}}},s={args:{innerHTML:"Een koptekst die in de koppenstructuur op het vierde niveau staat",level:4},parameters:{docs:{description:{story:A}}}},a={args:{innerHTML:"Een koptekst die in de koppenstructuur op het vijfde niveau staat",level:5},parameters:{docs:{description:{story:W}}}},r={args:{innerHTML:"Een koptekst die in de koppenstructuur op het zesde niveau staat",level:6},parameters:{docs:{description:{story:x}}}};var d,l,c;e.parameters={...e.parameters,docs:{...(d=e.parameters)==null?void 0:d.docs,source:{originalSource:`{
  args: {
...
}`,...(G=(b=a.parameters)==null?void 0:b.docs)==null?void 0:G.source}}};var w,D,M;r.parameters={...r.parameters,docs:{...(w=r.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
...
}`,...(M=(D=r.parameters)==null?void 0:D.docs)==null?void 0:M.source}}};const _=["HeadingLevel1","HeadingLevel2","HeadingLevel3","HeadingLevel4","HeadingLevel5","HeadingLevel6"];export{e as HeadingLevel1,n as HeadingLevel2,t as HeadingLevel3,s as HeadingLevel4,a as HeadingLevel5,r as HeadingLevel6,_ as __namedExportsOrder,R as default};
