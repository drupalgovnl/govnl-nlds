...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Een complete informatiepagina die alle componenten uit het NLDS toont in een samenhangende layout.',
      },
    },
  },
  tags: ['autodocs'],
...
export const InformatiePagina = {
  render: () => {
    ...
    leadParagraph.innerText =
      'Een moderne, toegankelijke en gebruiksvriendelijke design system voor Nederlandse overheidswebsites.';
    ...
    contentParagraph.innerText =
      'Dit design system biedt een uitgebreide set van herbruikbare componenten die zijn ontworpen volgens de Nederlandse toegankelijkheidsrichtlijnen. Alle componenten zijn getest op gebruiksvriendelijkheid en toegankelijkheid.';
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Een complete voorbeeldpagina die alle NLDS componenten toont in een realistische layout. Inclusief navigatie, content secties, buttons, links en footer.',
      },
    },
  },
};
