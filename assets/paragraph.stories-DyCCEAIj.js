import{BADGES as u}from"./preview-BIqUjC7G.js";const m=`<!-- @license CC0-1.0 -->
...
`,b={args:{innerHTML:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin non malesuada magna. Etiam lobortis, mauris ut euismod mattis, eros erat blandit nibh, ut finibus libero orci et elit. Quisque placerat lobortis interdum. Mauris ut tempor tellus. Curabitur lacinia mauris eget ultrices pellentesque. Aenean accumsan dui ut odio bibendum efficitur. Pellentesque consequat, orci congue cursus aliquet, risus sem tincidunt ex, porta sagittis diam dui feugiat nunc. Donec aliquet tortor sed nibh aliquet mollis."},argTypes:{innerHTML:{control:"text"},lead:{control:"boolean"}},parameters:{badges:[u.WIP],docs:{description:{component:h}}},render:({innerHTML:p,...c})=>{const r=["dictu-paragraph"],n=document.createElement("p");return c.lead&&r.push("dictu-paragraph--lead"),n.innerText=p,n.classList.add(...r),n},tags:["autodocs"],title:"Componenten/Paragraph"},e={args:{lead:!1},parameters:{docs:{description:{story:m}}}},a={args:{lead:!0},parameters:{docs:{description:{story:g}}}};var t,s,i;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`{
  args: {
    lead: false
  },
  parameters: {
...
}`,...(i=(s=e.parameters)==null?void 0:s.docs)==null?void 0:i.source}}};var o,d,l;a.parameters={...a.parameters,docs:{...(o=a.parameters)==null?void 0:o.docs,source:{originalSource:`{
  args: {
    lead: true
  },
  parameters: {
...
}`,...(l=(d=a.parameters)==null?void 0:d.docs)==null?void 0:l.source}}};const v=["Paragraph","Lead"];export{a as Lead,e as Paragraph,v as __namedExportsOrder,b as default};
