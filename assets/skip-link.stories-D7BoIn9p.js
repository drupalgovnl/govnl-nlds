...
`,l={argTypes:{innerHTML:{control:"text"},href:{control:"text"}},parameters:{docs:{description:{component:d}}},render:({innerHTML:r,href:o})=>{const a=["dictu-skip-link"],e=document.createElement("a");return e.innerText=r,e.href=o,e.classList.add(...a),e},tags:["autodocs"],title:"Componenten/Skip Link"},n={args:{innerHTML:"Ga direct naar inhoud",href:"#content"}};var i,t,s;n.parameters={...n.parameters,docs:{...(i=n.parameters)==null?void 0:i.docs,source:{originalSource:`{
  args: {
