...
import '@dictu/page-footer/dist/index.css';
import '@dictu/page-header/dist/index.css';
...
const createSection = (title, content, id) => {
...
const createParagraph = text => {
  ...
  paragraph.classList.add('dictu-paragraph');
  ...
  logo.innerHTML = `
    <div class="dictu-logo__image">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -12 44 88" role="img">
        ...
        <path
          fill="var(--dictu-logo-emblem-color, #FFFFFF)"
...
const createFigure = (src, alt, caption) => {
  ...
  figure.innerHTML = `
    <img src="${src}" alt="${alt}" class="dictu-image" />
    <figcaption class="dictu-figure__caption">${caption}</figcaption>
  `;
  return figure;
};

const createFooter = args => {
  ...
  // Create container
  const container = document.createElement('div');
  container.classList.add('dictu-container', 'dictu-page-footer__container');
...
export const InformationPage = {
  render: () => {
    ...
    const headingParagraph = createParagraph(
      'Deze pagina is ontworpen om een overzicht te geven van de verschillende componenten en hoe ze samen kunnen worden gebruikt in een realistische layout.'
    );
    ...
    const extraParagraphContent = createParagraph(
      'Dit is een extra paragraaf die kan worden gebruikt om meer informatie te geven over de inhoud van de pagina. Het doel is om te laten zien hoe verschillende componenten kunnen worden gecombineerd in een realistische context.'
    );
    ...
    const richTextContent = createContainer([
      `<div class="dictu-rich-text"><p>Dit is een voorbeeld van rijke tekst die kan worden gebruikt om meer gedetailleerde informatie te geven. Het kan verschillende elementen bevatten zoals <strong>vetgedrukte tekst</strong>, <em>cursieve tekst</em>, en zelfs <a href="https://www.dictu.nl">links</a>.</p>
       <ul>
         <li>Opsomming 1</li>
         <li>Opsomming 2</li>
         <li>Opsomming 3</li>
