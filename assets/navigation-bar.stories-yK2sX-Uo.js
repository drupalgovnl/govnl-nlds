      ...
      <ul class="dictu-navigation-bar__list" id="nav-list" role="menubar">
        ${o.map(a=>`
          <li class="dictu-navigation-bar__item" role="none">
            <a href="${a.link}" class="dictu-navigation-bar__link" role="menuitem" tabindex="0">
              <span class="dictu-navigation-bar__title">${a.title}</span>
            </a>
          </li>
        `).join("")}
      </ul>
    `,n},args:{items:[{link:"https://www.dictu.nl",title:"Dienst ICT Uitvoering"},{link:"https://www.ez.nl",title:"Ministerie van Economische Zaken"},{link:"https://www.rijksoverheid.nl",title:"Rijksoverheid"}]}};var e,t,l;i.parameters={...i.parameters,docs:{...(e=i.parameters)==null?void 0:e.docs,source:{originalSource:`{
  render: args => {
...
}`,...(l=(t=i.parameters)==null?void 0:t.docs)==null?void 0:l.source}}};const g=["NavigationBar"];export{i as NavigationBar,g as __namedExportsOrder,c as default};
