/* empty css              *//* empty css              *//* empty css              */const j="",k={args:{},argTypes:{title:{control:"text",description:"De titel van de timeline"},data:{control:"object"}},parameters:{docs:{description:{component:j}}},tags:["autodocs"],title:"Componenten/Timeline"},w=a=>{const n=document.createElement("ol");n.classList.add("dictu-timeline__body");for(let i=0;i<a.length;i+=1){const e=a[i],t=document.createElement("li");t.classList.add("dictu-timeline__item");const o=p(!1,"3",e.label,e.expanded);if(t.appendChild(o),e.content){const d=g(e.content,e.expanded);t.appendChild(d)}if(e.children){const d=document.createElement("ol");d.classList.add("dictu-timeline__sub-list"),e.expanded||d.classList.add("dictu-display-none");for(let s=0;s<e.children.length;s+=1){const l=e.children[s],r=document.createElement("li");r.classList.add("dictu-timeline__sub-item");const v=p(!0,"4",l.label,l.expanded);if(r.appendChild(v),l.content){const b=g(l.content,l.expanded);r.appendChild(b)}d.appendChild(r)}t.appendChild(d)}n.appendChild(t)}return n},g=(a,n)=>{const i=document.createElement("div");i.classList.add("dictu-timeline__element-content-wrapper"),n||i.classList.add("dictu-display-none");const e=document.createElement("div");return e.classList.add("dictu-timeline__element-content"),e.innerHTML=a,i.appendChild(e),i},p=(a=!1,n,i,e)=>{const t=document.createElement("button");t.classList.add("dictu-timeline__element-button","dictu-button","dictu-button--subtle"),t.setAttribute("aria-expanded",e);const o=document.createElement("span");o.classList.add("dictu-timeline__element-heading-body");const d=f(a);d.classList.add(a?"dictu-timeline__icon--subheading":"dictu-timeline__icon--heading");const s=document.createElement(`h${n}`);return s.classList.add("dictu-heading",`dictu-heading--level-${n}`,"dictu-timeline__element-heading"),s.textContent=i,o.appendChild(d),o.appendChild(s),t.appendChild(o),t},f=(a=!1)=>{const n=document.createElement("span");return a?n.innerHTML=`
    ...
    `,n.classList.add("dictu-timeline__icon"),n},c={render:({title:a,data:n})=>{const i=document.createElement("div");i.classList.add("dictu-timeline");const e=document.createElement("h2");e.classList.add("dictu-timeline__title","dictu-heading","dictu-heading--level-2"),e.textContent=a,i.appendChild(e);const t=w(n);return i.appendChild(t),i},args:{title:"Tijdlijn",data:[{label:"Tijdlijn Heading met children",expanded:!0,children:[{label:"Tijdlijn Subheading",expanded:!0,content:`
              <p class="dictu-paragraph">Content informatie 1.1.1. Content was nog niet geschreven. Linkjes in de tekst verwijst naar het document Door gaswinning uit het Groningenveld ontstaan in Groningen aardbevingen. Met het definitief beëindigen van de gaswinning in 2024 is de oorzaak van aardbevingen weggenomen. </p>
              <p class="dictu-paragraph">Content informatie 1.1.2. Content was nog niet geschreven. Linkjes in de tekst verwijst naar het document Door gaswinning uit het Groningenveld ontstaan in Groningen aardbevingen. Met het definitief beëindigen van de gaswinning in 2024 is de oorzaak van aardbevingen weggenomen. </p>
...
}`,...(u=(m=c.parameters)==null?void 0:m.docs)==null?void 0:u.source}}};const T=["Timeline"];export{c as Timeline,T as __namedExportsOrder,k as default};
