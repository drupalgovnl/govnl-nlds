import{j as e,M as r,T as l,S as h,C as t,A as c,a as u}from"./blocks-CgmsJYHR.js";import{useMDXComponents as s}from"./index-8zCqh1E6.js";import{N as a,a as d,R as m,b,c as j,d as g}from"./navigation-bar.stories-70Bux1d8.js";import"./preload-helper-Dp1pzeXC.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-5sULlumf.js";/* empty css              *//* empty css              *//* empty css              *//* empty css              */import"./icon.component-X7CMXdF1.js";function o(i){const n={a:"a",code:"code",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",ul:"ul",...s(),...i.components};return e.jsxs(e.Fragment,{children:[`
`,`
...
`,e.jsx(n.h3,{id:"navigatiebalk-met-bigmenu",children:"Navigatiebalk met bigmenu"}),`
`,e.jsxs(n.p,{children:["Het eerdere ",e.jsx(n.code,{children:"Submenu"}),` in de navigatiebalk toont de content binnen een lay-out met één kolom, wat de schaalbaarheid voor applicaties met complexe navigatiestructuren beperkt.
Aan de hand van de `,e.jsx(n.code,{children:"isBigMenu"})," boolean kan de ",e.jsx(n.code,{children:"big-menu"})," weergave gebruikt worden, waarbij de layout over vier kolommen wordt getoont."]}),`
`,e.jsx(n.h4,{id:"opengeklapt-bigmenu",children:"Opengeklapt bigmenu"}),`
`,e.jsx(t,{of:g,story:{height:"500px"}}),`
...
`,e.jsxs(n.p,{children:["Heb je een vraag over deze component of het DICTU Design System? ",e.jsx(n.a,{href:"?path=/docs/informatie-team--docs",children:"Neem dan contact op met het team"}),"."]})]})}function H(i={}){const{wrapper:n}={...s(),...i.components};return n?e.jsx(n,{...i,children:e.jsx(o,{...i})}):o(i)}export{H as default};
