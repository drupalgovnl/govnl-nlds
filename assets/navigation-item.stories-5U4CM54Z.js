import{r as m}from"./README-BVhbVEmO.js";/* empty css              */const p={argTypes:{icon:{options:["home"],mapping:{home:'<span class="dictu-icon" aria-hidden="true"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M11.2929 2.29289C11.6834 1.90237 12.3166 1.90237 12.7071 2.29289L21.7071 11.2929C21.9931 11.5789 22.0787 12.009 21.9239 12.3827C21.7691 12.7564 21.4045 13 21 13H20V19C20 20.6569 18.6569 22 17 22H7.00003C5.34318 22 4.00003 20.6569 4.00003 19V13H3.00003C2.59557 13 2.23093 12.7564 2.07615 12.3827C1.92137 12.009 2.00692 11.5789 2.29292 11.2929L11.2929 2.29289ZM11 14C10.4477 14 10 14.4477 10 15V20H14V15C14 14.4477 13.5523 14 13 14H11ZM18 19C18 19.5523 17.5523 20 17 20H16V15C16 13.3431 14.6569 12 13 12H11C9.34318 12 8.00003 13.3431 8.00003 15V20H7.00003C6.44775 20 6.00003 19.5523 6.00003 19L6.00003 12C6.00003 11.5712 5.73013 11.2054 5.35094 11.0633L12 4.41421L18.6491 11.0633C18.2699 11.2054 18 11.5712 18 12L18 19Z" fill="#154273"/></svg></span>'},control:{type:"select",labels:{home:"Home"}}},link:{control:"text"},title:{control:"text"}},parameters:{docs:{description:{component:m}}},tags:["autodocs"],title:"Componenten/NavigationItem"},t={render:o=>{const n=document.createElement("li"),{icon:r,link:s,title:c}=o||"",l=r||"";return n.classList.add(["dictu-navigation-bar","dictu-navigation-bar__item"]),n.setAttribute("role","none"),n.setAttribute("aria-required-parent","ul[role=menubar]"),n.innerHTML=`
      <a href="${s}" class="dictu-navigation-bar__link" role="menuitem" tabindex="0">
        ${l}
        <span class="dictu-navigation-bar__icon"></span>
        ${c}
      </a>
    `,n},args:{icon:"home",title:"Dienst ICT Uitvoering",link:"https://www.dictu.nl"}};var e,i,a;t.parameters={...t.parameters,docs:{...(e=t.parameters)==null?void 0:e.docs,source:{originalSource:`{
  render: args => {
...
}`,...(a=(i=t.parameters)==null?void 0:i.docs)==null?void 0:a.source}}};const g=["NavigationItem"];export{t as NavigationItem,g as __namedExportsOrder,p as default};
