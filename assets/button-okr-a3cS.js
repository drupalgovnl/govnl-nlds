import{j as e,M as s,T as a,S as l,C as i,A as h,h as j}from"./blocks-BpQWFNEv.js";import{useMDXComponents as c}from"./index-BVPzliWv.js";import{B as t,P as o}from"./button.stories-EmND38U9.js";import"./iframe-BDIq9sPw.js";import"./_commonjsHelpers-CqkleIqs.js";/* empty css              *//* empty css              */import"./button-DWuSISss.js";import"./icon.component-BiJB5nKt.js";const u=`<!-- @license CC0-1.0 -->
...
`,e.jsxs(n.p,{children:["Heb je een vraag over deze component of het DICTU Design System? ",e.jsx(n.a,{href:"?path=/docs/informatie-team--docs",children:"Neem dan contact op met het team"}),"."]})]})}function A(r={}){const{wrapper:n}={...c(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(d,{...r})}):d(r)}export{A as default};
