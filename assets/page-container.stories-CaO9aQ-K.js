const l=`Gebruik in CSS de \`.dictu-page-container\` class name voor de page-container component.
...
`,m={args:{content:`
    ...
    `,id:"page-container-1"},argTypes:{content:{control:"text",description:"De HTML inhoud van de page-container"},id:{control:"text",description:"Container ID voor navigatie en toegankelijkheid"}},parameters:{docs:{description:{component:g}}},render:({content:e,id:s})=>{const n=document.createElement("div");if(n.classList.add("dictu-page-container"),n.setAttribute("id",s),e){if(typeof e=="string"){const c=new DOMParser().parseFromString(e,"text/html"),t=document.createDocumentFragment();Array.from(c.body.childNodes).forEach(d=>{t.appendChild(d.cloneNode(!0))}),n.appendChild(t)}e instanceof HTMLElement&&n.appendChild(e)}return n},tags:["autodocs"],title:"Componenten/Page Container"},i={args:{},parameters:{docs:{description:{story:l}}}};var a,o,r;i.parameters={...i.parameters,docs:{...(a=i.parameters)==null?void 0:a.docs,source:{originalSource:`{
  args: {},
  parameters: {
    docs: {
      description: {
