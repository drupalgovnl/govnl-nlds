/* empty css              */import{L as B}from"./link.component-CBfmraUq.js";import{I as d}from"./icon.component-X7CMXdF1.js";const y=({crumbs:e,classNames:a,isMobile:n})=>{const w=d({icon:`<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
...
}`,...(h=(f=r.parameters)==null?void 0:f.docs)==null?void 0:h.source}}};var k,L,v;s.parameters={...s.parameters,docs:{...(k=s.parameters)==null?void 0:k.docs,source:{originalSource:`{
  args: {
    crumbs: [{
      label: 'Home',
      link: '/'
...
}`,...(v=(L=s.parameters)==null?void 0:L.docs)==null?void 0:v.source}}};const E=["DefaultBreadcrumbs","LongBreadcrumbs","MobileBreadcrumbs"],j=Object.freeze(Object.defineProperty({__proto__:null,DefaultBreadcrumbs:l,LongBreadcrumbs:r,MobileBreadcrumbs:s,__namedExportsOrder:E,default:M},Symbol.toStringTag,{value:"Module"}));export{j as B,l as D,r as L,s as M};
