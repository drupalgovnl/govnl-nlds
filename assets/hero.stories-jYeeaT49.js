/* empty css              */const f=`<!-- @license CC0-1.0 -->
...
`,H=["top-left","top-right","bottom-left","bottom-right"],C=["left","right"],j={args:{headingLevel:2,heading:"Hero Heading",subheading:"Hero Subheading",cornerPosition:"top-right",messagePosition:"left",width:"1280",height:"495"},argTypes:{headingLevel:{control:"select",options:[1,2,3,4,5],description:"Heading level in de hero"},heading:{control:"text",description:"De titel van de hero"},subheading:{control:"text",description:"De ondertitel van de hero"},cornerPosition:{control:"select",options:H,description:"De positie van de hoekafbeelding"},messagePosition:{control:"select",options:C,description:"De positie van de inhoud in de hero"}},parameters:{docs:{description:{component:f}}},tags:["autodocs"],title:"Componenten/Hero"},L=(r,o,h="heading")=>{if(!r||!o)return null;const l=`dictu-hero__${h}`,e=document.createElement(`h${o}`);return e.classList.add(`${l}`,"dictu-heading",`dictu-heading--level-${o}`),e.textContent=r,e},k=({heading:r,subheading:o,cornerPosition:h,messagePosition:l,...e})=>{const a=document.createElement("section");a.classList.add("dictu-section"),a.classList.add("dictu-hero");const d=document.createElement("div");d.classList.add("dictu-container","dictu-hero__container"),a.appendChild(d);const n=document.createElement("img");n.src="assets/huis-in-groningen.jpg",n.alt=e.alt||"",n.loading=e.imageLoading||"lazy",n.classList.add("dictu-hero__image","dictu-aspect-ratio-hero"),n.classList.add(`dictu-hero__image--corner-${h}`),n&&d.appendChild(n);const t=document.createElement("div");t.classList.add("dictu-hero__message"),t.classList.add(`dictu-hero__message--${l}`),d.appendChild(t);const g=L(r,e.headingLevel);g&&(g.classList.add("dictu-hero__heading"),t.appendChild(g));const s=document.createElement("p");return s.classList.add("dictu-paragraph","dictu-hero__subheading"),s.textContent=o,s&&t.appendChild(s),a},i={render:k},c={args:{...i.args,heading:"Hero Titel Mobiel",subheading:"Dit is een beschrijvende ondertitel speciaal voor mobiele weergave."},parameters:{viewport:{defaultViewport:"mobile1"},docs:{description:{story:"De hero component geoptimaliseerd voor mobiele weergave met aangepaste lettergroottes en compactere layout."}}},render:k};var u,p,m;i.parameters={...i.parameters,docs:{...(u=i.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: renderHero
}`,...(m=(p=i.parameters)==null?void 0:p.docs)==null?void 0:m.source}}};var v,b,_;c.parameters={...c.parameters,docs:{...(v=c.parameters)==null?void 0:v.docs,source:{originalSource:`{
  args: {
    ...Hero.args,
  ...
  render: renderHero
}`,...(_=(b=c.parameters)==null?void 0:b.docs)==null?void 0:_.source}}};const D=["Hero","HeroMobiel"];export{i as Hero,c as HeroMobiel,D as __namedExportsOrder,j as default};
