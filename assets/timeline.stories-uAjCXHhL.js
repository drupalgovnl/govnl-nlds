/* empty css              */const j="",x={args:{},argTypes:{title:{control:"text",description:"De titel van de timeline"},data:{control:"object"}},parameters:{docs:{description:{component:j}}},tags:["autodocs"],title:"Componenten/Timeline"},w=a=>{const n=document.createElement("ol");n.classList.add("dictu-timeline__body");for(let t=0;t<a.length;t+=1){const e=a[t],i=document.createElement("li");i.classList.add("dictu-timeline__item");const l=p(!1,"3",e.label,e.expanded);if(i.appendChild(l),e.content){const d=g(e.content,e.expanded);i.appendChild(d)}if(e.children){const d=document.createElement("ol");d.classList.add("dictu-timeline__sub-list"),e.expanded||d.setAttribute("hidden","");for(let o=0;o<e.children.length;o+=1){const s=e.children[o],r=document.createElement("li");r.classList.add("dictu-timeline__sub-item");const v=p(!0,"4",s.label,s.expanded);if(r.appendChild(v),s.content){const b=g(s.content,s.expanded);r.appendChild(b)}d.appendChild(r)}i.appendChild(d)}n.appendChild(i)}return n},g=(a,n)=>{const t=document.createElement("div");t.classList.add("dictu-timeline__element-content-wrapper"),n||t.setAttribute("hidden","");const e=document.createElement("div");return e.classList.add("dictu-timeline__element-content"),e.innerHTML=a,t.appendChild(e),t},p=(a=!1,n,t,e)=>{const i=document.createElement("button");i.classList.add("dictu-timeline__element-button","dictu-button","dictu-button--subtle"),i.setAttribute("aria-expanded",e);const l=document.createElement("span");l.classList.add("dictu-timeline__element-heading-body");const d=f(a);d.classList.add(a?"dictu-timeline__icon--subheading":"dictu-timeline__icon--heading");const o=document.createElement(`h${n}`);return o.classList.add("dictu-heading",`dictu-heading--level-${n}`,"dictu-timeline__element-heading"),o.textContent=t,l.appendChild(d),l.appendChild(o),i.appendChild(l),i},f=(a=!1)=>{const n=document.createElement("span");return a?n.innerHTML=`
