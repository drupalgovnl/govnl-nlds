import{j as e,M as s,T as o,S as c,C as i,A as h,a as j}from"./blocks-CgmsJYHR.js";import{useMDXComponents as l}from"./index-8zCqh1E6.js";import{L as a,D as d,R as g,a as u}from"./language-switcher.stories-BPBCGySu.js";import"./preload-helper-Dp1pzeXC.js";import"./_commonjsHelpers-CqkleIqs.js";import"./iframe-5sULlumf.js";/* empty css              */import"./language-switcher.component-DAkIERlr.js";import"./icon.component-X7CMXdF1.js";function r(t){const n={a:"a",code:"code",em:"em",h2:"h2",h3:"h3",li:"li",p:"p",strong:"strong",ul:"ul",...l(),...t.components};return e.jsxs(e.Fragment,{children:[`
`,`
...
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"ARROW DOWN"})," / ",e.jsx(n.code,{children:"ARROW UP"}),": Binnen het geopende menu kan hiermee door de verschillende taalopties genavigeerd worden."]}),`
`]}),`
...
`,e.jsxs(n.p,{children:["Heb je een vraag over deze component of het DICTU Design System? ",e.jsx(n.a,{href:"?path=/docs/informatie-team--docs",children:"Neem dan contact op met het team"}),"."]})]})}function D(t={}){const{wrapper:n}={...l(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(r,{...t})}):r(t)}export{D as default};
