import{I as o,J as e}from"../vite-inject-mocker-entry.js";import{j as s}from"./storybook-0AdLr-R1.js";import"./axe-BkbROpEY.js";function i(t){const n={a:"a",h1:"h1",h2:"h2",p:"p",...o(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(s,{title:"Voor designers/Introductie"}),`
...
`,e.jsxs(n.p,{children:["Kun je niet bij de Figma bestanden? ",e.jsx(n.a,{href:"?path=informatie-team--docs",children:"Neem dan contact op met het Dictu Design System team"}),"."]})]})}function d(t={}){const{wrapper:n}={...o(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(i,{...t})}):i(t)}export{d as default};
