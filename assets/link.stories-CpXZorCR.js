import{BADGES as l}from"./preview-2NqGIXso.js";const c=`<!-- @license CC0-1.0 -->
...
`,m={args:{href:"dictu.nl"},argTypes:{innerHTML:{control:"text"},href:{control:"text"}},parameters:{badges:[l.WIP],docs:{description:{component:c}}},render:({innerHTML:o,href:r})=>{const a=["dictu-link"],e=document.createElement("a");return e.innerText=o,e.href=r,e.classList.add(...a),e},tags:["autodocs"],title:"Componenten/Link"},n={args:{innerHTML:"Dit is een link"}};var t,i,s;n.parameters={...n.parameters,docs:{...(t=n.parameters)==null?void 0:t.docs,source:{originalSource:`{
  args: {
