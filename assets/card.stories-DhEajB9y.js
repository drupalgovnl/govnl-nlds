/* empty css              *//* empty css              */import{H}from"./heading.component-CzcCeUlG.js";import{I as Z}from"./icon.component-X7CMXdF1.js";import{L as B}from"./link.component-KS7kVO7o.js";const F=({headingLevel:w,link:a,content:M,footer_content:l,variant:A="default",image_src:S,alt:O,icon:g,subheading:u,full_card_link:T})=>{const v=!!T,e=document.createElement("div");e.classList.add("dictu-card",`dictu-card--${A}`,"dictu-focus-ring"),v?(e.href=a.href,e.setAttribute("role","link")):e.setAttribute("role","article");const m=document.createElement("div");m.classList.add("dictu-card__image-container");const o=document.createElement("img");o.classList.add("dictu-image","dictu-card__image"),o.src=S||"",o.alt=O||"",m.appendChild(o);const f=g?Z({icon:g}):null,y=B({content:(a==null?void 0:a.text)??"",href:a.href,classNames:v?"dictu-card__link dictu-card__full-card-link":"dictu-card__link"}),_=H({content:y,level:w});_.classList.add("dictu-card__heading");const t=document.createElement("div");t.classList.add("dictu-card__content"),f&&t.appendChild(f),t.appendChild(_);const d=document.createElement("p");d.classList.add("dictu-card__subheading"),d.innerText=u||"";const p=[];u&&(p.push(d.id),t.appendChild(d));const s=document.createElement("p");s.classList.add("dictu-card__paragraph"),s.innerText=M??"",p.push(s.id),t.appendChild(s);const c=document.createElement("small");return c.classList.add("dictu-card__metadata"),l&&(c.innerText=l,p.push(c.id)),l&&t.appendChild(c),e.appendChild(m),e.appendChild(t),e},I={args:{image_src:"assets/example-image.jpg",alt:"Dit is een voorbeeld afbeelding",headingLevel:2,link:{href:"#",text:"Lees meer"},content:"Dit is een voorbeeld van de inhoud van de kaart.",footer_content:"Dit is een voorbeeld van de footer content",variant:"default",icon:`<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
}`,...(b=(k=n.parameters)==null?void 0:k.docs)==null?void 0:b.source}}};var C,L,x;r.parameters={...r.parameters,docs:{...(C=r.parameters)==null?void 0:C.docs,source:{originalSource:`{
  args: {
    image_src: 'assets/example-image.jpg',
...
}`,...(x=(L=r.parameters)==null?void 0:L.docs)==null?void 0:x.source}}};var D,E,j;i.parameters={...i.parameters,docs:{...(D=i.parameters)==null?void 0:D.docs,source:{originalSource:`{
  args: {
    image_src: 'assets/example-image.jpg',
    alt: 'Dit is een voorbeeld afbeelding voor een kaart',
    link: {
...
}`,...(j=(E=i.parameters)==null?void 0:E.docs)==null?void 0:j.source}}};const z=["DefaultCard","AccentCard","FullCardLink"],J=Object.freeze(Object.defineProperty({__proto__:null,AccentCard:r,DefaultCard:n,FullCardLink:i,__namedExportsOrder:z,default:I},Symbol.toStringTag,{value:"Module"}));export{r as A,J as C,n as D};
